...
import { DotMatrixBase } from '@/web/lib/dotmatrix-core';
import { useDotMatrixPhases } from '@/web/lib/dotmatrix-hooks';
import { spiralInwardNormFromIndex, spiralInwardOrderValue } from '@/web/lib/dotmatrix-core';
import { usePrefersReducedMotion } from '@/web/lib/dotmatrix-hooks';
import type { DotAnimationResolver, DotMatrixCommonProps } from '@/web/lib/dotmatrix-core';
